...
<body>
  ...
  <div class="container">
    ...
    <!-- Page Heading/Breadcrumbs -->
      <h1 class="mt-4 mb-3">Actualizar <small>Puerto</small>
    </h1>
      ...
      <div class="row">
          <div class="col-lg-12 mb-12">
              <form  action="/puerto/actualizar" method="post" th:object="${puerto}">
                  <input type="hidden" name="id" id="id" value="${puerto.id}">
                  <input type="hidden" name="parte" id="parte" value="${parteId}">

                  <div class="form-group">
                      <label for="cantidad">Cantidad</label>
                      <input type="number" class="form-control" name="cantidad" id="cantidad" value="${puerto.cantidad}">
                  </div>

                  <div class="form-group">
                      <label for="version">Version</label>
                      <input type="number" class="form-control" name="version" id="version" value="${puerto.version}">
                  </div>
