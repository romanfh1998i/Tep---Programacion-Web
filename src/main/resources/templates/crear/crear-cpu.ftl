...
<body>
  ...
  <div class="container pb-3">
    ...
    <h1 class="mt-4 mb-3">Crear <small>CPU</small></h1>

    <!-- Content Row -->
    <div class="row">
      <div class="col-lg-12 mb-12">
        <form  action="/cpu/agregar" method="post" th:object="${cpu}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="consumo_energia" id="consumo_energia" min="0" class="form-control">
            </div>
