...
<body>
    ...
    <div class="container">
        <div class="row">
            <h1 class="my-4">Información de <small>Tipo CPU</small></h1>
                ...
                <tbody>
                    <#if tipoCpu??>
                        ...
                        <tr>
                            ...
                            <td><a href="/tipoCpu/actualizar/${t.id}"><i style = "font-size: 24px; color: darkorange" class="fa fa-edit"></i></a></td>
            ...
            <div class="row">
                <div class="col-md-2 mb-3">
                    <a href="/tipoCpu/agregar" class="btn btn-info">Agregar otro</a>
                </div>
            </div>
        </div>
    </div>
